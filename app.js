...
console.log(exp); // expected output "faraz"

// second expression
let b = 3;
let exp1 = 1 + 2 + ++b || (5 && 0);
console.log(exp1); // expected output 7

// third expression
let a = 5;
let exp2 = (32 && true - ++a && " ") || "true";
console.log(exp2); // expected output " "

// fourth expression
let exp3 = ((true + 3) * 5 && undefined) || "faraz" + 5;
console.log(exp3); // expected output faraz5

// fifth expression
let exp4 = 32 + "abc" || true + false + false || +5 || "true";
console.log(exp4); // expected output 32abc

// sixth expression
let exp5 = false || (true + true + 15 && "") || 50;
console.log(exp5); // expected output 50

// seventh expression
let exp6 = true + false + 5 || false + 8 + "abc" || "true";
console.log(exp6); // expected output 6

// eight expression
let exp7 = "faraz" || false + 10 || "true";
console.log(exp7); // expected output faraz

// ninth expression
let exp8 = (12 + (false + false) + true && null) || "faraz";
console.log(exp8); // expected output faraz

// tenth expression
let exp9 = false + true + false + 2 || ("faraz" && false) || 1 + 10;
console.log(exp9); // expected output 3

// eleventh expression
let exp10 = true + false + 5 || false + 8 + "abc" || "true";
console.log(exp10); // expected output 6

// twelveth expression
let exp11 =
  ((true + false) * 3 && "") || false + true - (12 + true + true + false);
console.log(exp11); // expected output -13
...
let brand = Object.keys(mobiles);
for (let i = 0; i < brand.length; i++) {
  const option = document.createElement("option");
  option.value = brand[i];
  option.textContent = brand[i].charAt(0).toUpperCase() + brand[i].slice(1);
...
brandSelect.addEventListener("change", function () {
  ...
  let model = Object.keys(mobiles[brand]);
...
searchButton.addEventListener("click", function () {
  ...
  let rarCamera, ultra, tP, tPP, fCamera, btry, OS;
  const selectedModel = mobiles[brand][model];
  if (brand === "iphone" || brand === "xiomi") {
    rarCamera = selectedModel.camera.rear.main;
    ultra = selectedModel.camera.rear.ultra;
    tP = selectedModel.camera.rear.telephoto;
    tPP = selectedModel.camera.rear.telephotoPeriscope;
    fCamera = selectedModel.camera.front;
    btry = selectedModel.battery;
    OS = selectedModel.operatingSystem;
  } else if (brand === "realme") {
    rarCamera = selectedModel.camera.rear.resolution;
    ultra = "";
    tP = "";
    tPP = "";
    fCamera = selectedModel.camera.front.resolution;
    btry = selectedModel.battery.capacity;
    OS = selectedModel.operatingSystem;
  } else if (brand === "samsung") {
    rarCamera = selectedModel.rearCamera.megapixel;
    ultra = "";
    tP = "";
    tPP = "";
    fCamera = selectedModel.frontCamera.megapixel;
    btry = selectedModel.batteryCapacity;
    OS = selectedModel.os;
  }
  if (brand && model) {
    resultDiv.innerHTML = ` <h2>Brand: ${
      brand.charAt(0).toUpperCase() + brand.slice(1)
    } Model: ${model}</h2>
    <p><strong>Processor:</strong> ${selectedModel.processor}</p>
    <p><strong>Memory:</strong> RAM: ${
      selectedModel.ram ? selectedModel.ram : selectedModel.memory.ram
    } , Storage: ${
    ...
    <p>
  <strong>Camera:</strong> Rear: Main: ${rarCamera} 
    , Ultrawide: ${ultra}
  , Telephoto: ${tP}
  , Telephoto Periscope: ${tPP}
 , Front: ${fCamera}
    </p>
    <p><strong>Battery:</strong> ${btry}</p>
